...
public class ClienteDao {
	...
	public Cliente traerClienteYComandas(int idCliente) throws HibernateException {
		Cliente objeto = null ;
		try {
			iniciaOperacion();
	...
	public boolean existeCliente(int id) throws HibernateException {

		Cliente objeto = null;
		
		try {
			iniciaOperacion();
			objeto = (Cliente) session.createQuery("from Cliente c where c.idCliente ="+ Integer.toString(id)).uniqueResult();
		} finally {
			session.close();
		}
	...
	public boolean existeCliente(long dni) throws HibernateException {
